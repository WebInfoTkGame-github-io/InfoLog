...
<html lang="en">
  <head>
    ...
    <title>Team-Up | Form Tournament</title>
  </head>
  <body>
    <!-- Header -->
        <!-- Navbar -->
            ...
            <div class="col-sm-12">
                <form>
                    <div class="form-group">
                        <label for="nama">Name Tournament</label>
                        <input type="text" id="nama" class="form-control">
                    </div>    
                    <div class="form-group">
                        <label for="email">Detail Tournament</label><br>
                        <textarea style="resize:none" class="form-control" rows="10"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="Pesan">Regist Fee</label>
                        <input type="email" id="nama" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="Pesan">Prizes</label>
                        <input type="email" id="nama" class="form-control">
                    </div>
                    <div class="form-group">
